...
Your ONLY task is to convert that information into the exact Cortex JSON schema below.
...
1. Preserve all useful facts from the input.
2. Do not invent missing information.
3. Missing string values must be:
   "Not found in the repository."
4. Missing array values must be:
   []
5. Keep the information concise but useful.
6. The output must contain exactly the 12 top-level fields shown above.
7. Do not include any additional top-level fields.
8. Do not use Markdown fences.
9. Do not write any explanation before or after the JSON.
