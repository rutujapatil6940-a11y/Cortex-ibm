...
//
// On a fresh page load / browser refresh, we ONLY restore
// localStorage. This means a non-remembered session will
...
function readPersistedSession() {
  ...
  // Only localStorage is restored after refresh.
  if (!token || !savedUser) {
    return {
      isLoggedIn: false,
      user: {
...
function App() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (rememberMe) {
        ...
        // REMEMBER ME CHECKED
        //
        // localStorage survives refresh and browser reopen.
        // -------------------------------------------------
        ...
        //
        // sessionStorage is available while this page
        // session is alive.
        //
        // IMPORTANT:
        // readPersistedSession() intentionally does NOT
        // restore sessionStorage after a page refresh.
        // Therefore refresh sends the user back to login.
        // -------------------------------------------------
  ...
  const handleRunRepositoryAnalysis =
    async (analysisId) => {
  ...
  const handleUpdateProfile =
    async (e) => {
      ...
      /*
        ...
        For now it updates frontend + storage.
      */
